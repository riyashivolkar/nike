...
const Hero = () => {
  ...
  return (
    <section
      id="#home"
      className="flex flex-col justify-center w-full min-h-screen gap-10 p-2 max-container xl:flex-row"
    >
      ...
      <div className="relative flex items-center justify-center flex-1 bg-center bg-cover xl:min-h-screen max-xl:py-40 bg-primary bg-hero">
        ...
        <div className="flex-row flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm px-6">
